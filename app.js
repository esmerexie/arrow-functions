...
// it is referring to the student object joe Schmoe with the age and hometown
// 2. What is "this" when joe.scopeArrow() is invoked?
// it is referring to a window or an ip address, specifically the webpage
// 3. Explain why "this" is different when an arrow function is used.
// in a  normal function this can be reached globally as where in an arrow function this cannot be redefined as in an arrow function it can only be called within the function and not globally.